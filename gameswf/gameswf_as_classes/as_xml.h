...
struct xmlattr_Object : public gameswf::Object
{
  //XMLAttr obj;
  int   padding;
  ...
  xmlattr_Object() 
  {
    log_msg("\t\tCreating xmlattr_Object at %p\n", this);
  };
  ~xmlattr_Object() 
  {
    log_msg("\tDeleting xmlattr_Object at %p \n", this);
  };
#endif
};
...
public:
  ...
  void  change_stack_frame(int frame, gameswf::Object *xml, gameswf::as_environment *env);
...
struct xmlnode_Object : public gameswf::Object
{
  //XMLNode obj;
  int                _padding;
  ...
  xmlnode_Object() 
  {
    log_msg("\tCreating xmlnode_Object at %p \n", this);
  };
  ~xmlnode_Object() 
  {
    log_msg("\tDeleting xmlnode_Object at %p \n", this);
  };
#endif
...
class XML {
 public:
  ...
  void  change_stack_frame(int frame, gameswf::Object *xml, gameswf::as_environment *env);
  void  setupStackFrames(gameswf::Object *xml, gameswf::as_environment *env);
  void  cleanupStackFrames( XMLNode *data);
  Object *setupFrame(gameswf::Object *xml, XMLNode *data, bool src);
  ...
  //    hash<gameswf::event_id, gameswf::Value>	_event_handlers;
#if 0
...
struct xml_Object : public gameswf::Object
{
  XML obj;
#ifdef DEBUG_MEMORY_ALLOCATION
  xml_Object() 
  {
    log_msg("\tCreating xml_Object at %p\n", this);
  };
  ~xml_Object() 
  {
    log_msg("\tDeleting xml_Object at %p\n", this);
  };
#endif
  virtual bool	get_member(const tu_string& name, Value* val)
  {
...
exported_module virtual bool is_instance_of(const Function& constructor) const;
