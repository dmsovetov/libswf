...
namespace gameswf
{
	...
	struct mouse_button_state
	{
        ...
        gc_ptr<character> m_intersected_entity; ///!!!Plarium
	...
	struct root : public ref_counted
	{
		...
		void add_listener(Object* obj)  { m_listener.add(obj); }
		bool remove_listener(Object* obj) { return m_listener.remove(obj); }
		void add_mouse_listener(Object* obj)  { m_mouse_listener.add(obj); }
		bool remove_mouse_listener(Object* obj) { return m_mouse_listener.remove(obj); }
		void add_keypress_listener(Object* obj)  { m_keypress_listener.add(obj); }
		bool remove_keypress_listener(Object* obj) { return m_keypress_listener.remove(obj); }
	};
}
