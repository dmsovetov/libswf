...
namespace gameswf
{
	...
	struct generic_character : public character
	{
		...
		virtual bool get_topmost_mouse_entity( character * &te, float x, float y, bool shouldHandleMouse )  ///!!!Plarium - shouldHandleMouse
		{
    ...
    void    define_scaling_grid(stream* in, int tag_type, movie_definition_sub* m);	///!!!Plarium
