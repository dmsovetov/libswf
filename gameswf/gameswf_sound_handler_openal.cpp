...
namespace gameswf
{
	...
	void	openal_sound_handler::play_sound(Object* listener_obj, int sound_handle, int loops)
	...
	void	openal_sound_handler::attach_aux_streamer(aux_streamer_ptr ptr, Object* netstream)
	{
		assert(netstream);
		assert(ptr);
	...
	void openal_sound_handler::detach_aux_streamer(Object* netstream)
	{
		m_mutex.lock();
		//TODO
		m_mutex.unlock();
