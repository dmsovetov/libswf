...
// 			}
		...
		///!!!Plarium
        void    set_scaling_grid(const scaling_grid* scalingGrid)
        {
            if (s_render_handler) s_render_handler->set_scaling_grid(scalingGrid);
        }
        void    set_slice_index(int index)
        {
            if (s_render_handler) s_render_handler->set_slice_index(index);
        }
