...
namespace gameswf
{
	...
	struct font : public character_def
	{
		...
		const tu_string& get_name() const { return m_identifier != "" ? m_identifier : m_fontname; }
		void	set_name(const tu_string& name) { m_fontname = name; }
        void    set_identifier(const tu_string& identifier) { m_identifier = identifier; }  ///!!!Plarium
        const tu_string& get_identifier() const { return m_identifier; }    ///!!!Plarium
		...
		float	get_ascent() const { return m_ascent; } ///!!!Plarium
	...
	private:
        ...
        tu_string   m_identifier;  ///!!!Plarium
		...
		// Dummy hash functor.
		{
			int	operator()(const T& data) const { return data; }
		};
