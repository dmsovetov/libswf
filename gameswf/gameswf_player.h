...
namespace gameswf
{
	typedef exported_module Object* (*gameswf_module_init)(player* player, const array<Value>& params);
	...
	{
		hash<gc_ptr<Object>, bool> m_heap;
	//	gc_ptr<Object>	m_global;
        ...
        exported_module void register_native_function(const char* identifier, FunctionNativeThunk callback, void* userData ); ///!!!Plarium
        ...
        exported_module bool is_valid_movie(const char* filename) const;  ///!!!Plarium
	...
	//	Object* get_global() const;
		...
		// the garbage manager
		void set_alive(Object* obj);
		bool is_garbage(Object* obj);
		void clear_heap();
		void set_as_garbage();
		void clear_garbage();
