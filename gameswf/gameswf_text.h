...
namespace gameswf
{
    ...
    void    as_global_get_text_format(const fn_call& fn);   ///!!!Plarium
    void    as_global_set_text_format(const fn_call& fn);   ///!!!Plarium
	...
	struct text_glyph_record
	{
        ...
        bool        m_is_aligned;   ///!!!Plarium

        text_glyph_record() : m_is_aligned(false) {}    ///!!!Plarium
